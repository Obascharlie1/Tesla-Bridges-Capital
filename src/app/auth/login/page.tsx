  ...
  return (
    <div className="w-full max-w-sm">
        ...
        <div>
          ...
          <div className="relative">
            <input
              ...
              required
              className="w-full px-4 py-3 pr-11 border border-light-border dark:border-dark-border bg-light-base dark:bg-dark-card text-dark-base dark:text-white placeholder:text-slate-400 text-sm focus:outline-none focus:border-green-primary transition-colors"
            />
        ...
        <div className="flex items-center justify-between">
          <label className="flex items-center gap-2 cursor-pointer select-none">
            <input
              ...
              className="w-4 h-4 border border-light-border dark:border-dark-border bg-light-base dark:bg-dark-card accent-green-primary flex-shrink-0"
            />
            <span className="text-xs text-slate-500 dark:text-slate-400">Remember me</span>
          </label>
          <Link href="/auth/forgot-password" className="text-xs text-green-primary hover:text-green-dim transition-colors font-medium">
            Forgot password?
          </Link>
        </div>
      ...
      <p className="mt-6 text-center text-sm text-slate-500 dark:text-slate-400">
        ...
        <Link href="/auth/register" className="text-green-primary hover:text-green-dim font-medium transition-colors">
          Create account
        </Link>
      </p>
    </div>
