      ...
      <div className="p-4 sm:p-6 max-w-5xl mx-auto space-y-5">
        ...
        <div className="grid grid-cols-3 gap-3 sm:gap-4">
          ...
          <div className="bg-light-base dark:bg-dark-card border border-light-border dark:border-dark-border rounded-xl p-4">
            ...
            <p className="text-base sm:text-lg font-bold text-green-primary">
        ...
        <div className="flex flex-col sm:flex-row gap-3">
          ...
          <div className="relative sm:ml-auto">
            ...
            <input
              ...
              className="w-full sm:w-64 pl-9 pr-4 py-2 text-sm border border-light-border dark:border-dark-border bg-light-base dark:bg-dark-card text-dark-base dark:text-white placeholder:text-slate-400 focus:outline-none focus:border-green-primary transition-colors"
            />
          </div>
        </div>
              ...
              <tbody className="divide-y divide-light-border dark:divide-dark-border">
                {filtered.map((tx) => (
                  <tr key={tx.id} className="hover:bg-light-surface dark:hover:bg-dark-surface transition-colors">
                    ...
                    <td className={`px-5 py-3.5 text-sm font-semibold ${tx.type === 'Withdrawal' ? 'text-green-primary' : 'text-dark-base dark:text-white'}`}>
          ...
          <div className="sm:hidden divide-y divide-light-border dark:divide-dark-border">
            {filtered.map((tx) => (
              <div key={tx.id} className="px-4 py-4 flex items-start justify-between gap-3">
                ...
                <p className={`text-sm font-bold flex-shrink-0 ${tx.type === 'Withdrawal' ? 'text-green-primary' : 'text-dark-base dark:text-white'}`}>
