      ...
      <div className="p-6 max-w-4xl mx-auto">
        ...
        {submitted ? (
          <div className="bg-light-base dark:bg-dark-card border border-light-border dark:border-dark-border rounded-xl p-8 text-center">
            ...
            <Link
              href="/dashboard"
              className="inline-flex items-center gap-2 px-5 py-2.5 bg-green-primary hover:bg-green-dim text-white text-sm font-bold transition-colors"
            >
              Back to Dashboard
            </Link>
          </div>
          ...
          <div className="space-y-5">
            ...
            <div className="bg-light-base dark:bg-dark-card border border-light-border dark:border-dark-border rounded-xl p-6">
              ...
              <div className="flex items-center gap-3 p-3 bg-light-surface dark:bg-dark-surface border border-light-border dark:border-dark-border">
                ...
                <button
                  onClick={copyEmail}
                  className="flex-shrink-0 flex items-center gap-1.5 px-3 py-1.5 border border-light-border dark:border-dark-border text-xs font-semibold text-slate-500 dark:text-slate-400 hover:border-green-primary hover:text-green-primary transition-colors"
                >
              ...
              <ol className="space-y-3">
                {steps.map((step, i) => (
                  <li key={i} className="flex gap-3">
                    <span className="flex-shrink-0 w-6 h-6 bg-green-primary text-white text-xs font-bold flex items-center justify-center">
                      {i + 1}
                    </span>
            ...
            <form onSubmit={handleSubmit} className="bg-light-base dark:bg-dark-card border border-light-border dark:border-dark-border rounded-xl p-6 space-y-5">
              {error && (
                <div className="px-4 py-3 bg-green-primary/10 border border-green-primary/30 text-green-primary text-sm">
                  {error}
                </div>
              )}
              <div>
              ...
              <div>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <button
                    type="button"
                    onClick={copyRef}
                    className="flex items-center gap-1.5 px-3 py-3 border border-light-border dark:border-dark-border text-xs font-semibold text-slate-500 dark:text-slate-400 hover:border-green-primary hover:text-green-primary transition-colors"
                  >
