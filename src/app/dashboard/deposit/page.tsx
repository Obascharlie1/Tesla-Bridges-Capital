        ...
        <div className="space-y-3">
          {methods.map((method) => (
            <Link
              key={method.href}
              href={method.href}
              className="flex items-center gap-5 p-6 bg-light-base dark:bg-dark-card border border-light-border dark:border-dark-border rounded-xl hover:border-green-primary transition-all group"
            >
              {/* Icon */}
              <div className="w-12 h-12 bg-green-primary/10 flex items-center justify-center flex-shrink-0 group-hover:bg-green-primary/15 transition-colors">
                <method.icon size={22} className="text-green-primary" />
              </div>
              ...
              <ChevronRight
                size={18}
                className="text-slate-400 group-hover:text-green-primary flex-shrink-0 transition-colors"
              />
            </Link>
          ))}
        </div>
