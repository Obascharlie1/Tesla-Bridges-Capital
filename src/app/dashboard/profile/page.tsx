...
const inputCls = 'w-full px-4 py-2.5 border border-light-border dark:border-dark-border bg-light-base dark:bg-dark-card text-dark-base dark:text-white text-sm focus:outline-none focus:border-green-primary transition-colors placeholder:text-slate-400'
    ...
    <div>
      ...
      <div className="p-4 sm:p-6 max-w-2xl mx-auto space-y-5 pb-16">
        ...
        <div className="bg-light-base dark:bg-dark-card border border-light-border dark:border-dark-border rounded-xl p-5 flex items-center gap-4">
          <div className="w-16 h-16 bg-green-primary flex items-center justify-center flex-shrink-0 text-white font-bold text-xl">
            {initials}
          </div>
          ...
          <button
            ...
            className="flex items-center gap-1.5 px-3 py-2 text-xs font-semibold border border-light-border dark:border-dark-border text-slate-500 dark:text-slate-400 hover:border-green-primary hover:text-green-primary transition-colors flex-shrink-0"
          >
        ...
        {error && (
          <div className="px-4 py-3 bg-green-primary/10 border border-green-primary/30 text-green-primary text-sm">{error}</div>
        )}
