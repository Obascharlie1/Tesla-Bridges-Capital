...
export function MessagesBell() {
  ...
  return (
    ...
    >
      ...
      {unread > 0 && (
        <span className="absolute -top-0.5 -right-0.5 min-w-[16px] h-4 px-0.5 flex items-center justify-center rounded-full bg-green-primary text-white text-[9px] font-bold">
          {unread > 9 ? '9+' : unread}
        </span>
      )}
    </Link>
